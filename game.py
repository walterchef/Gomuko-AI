...
class Game:
    ...
    def __init__(self, board: Board, graphics: Graphics, player1: Player, player2: Player):
        self.board = board
    ...
    def play(self) -> bool:  
        ...
        while self.running:
            ...
            if self.is_game_over():
                ...
                self.graphics.display_game_over_message(self.winner)  # Display winner message
